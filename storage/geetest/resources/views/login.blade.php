...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="{{ admin_base_path('auth/login') }}" method="post">
            ...
            <p id="notice" class="hide">{{ config('geetest.client_fail_alert')}}</p>
    ...
    $(function () {
        ...
        var geetest = function (url) {
            var handlerEmbed = function (captchaObj) {
                ...
                if ('{{ $product }}' == 'popup') {
                    captchaObj.bindOn($('#embed-captcha').closest('form').find(':submit'));
                    captchaObj.appendTo("#embed-captcha");
                }
            };
            $.ajax({
        ...
        (function () {
            geetest('{{ config('geetest.geetest_url', 'geetest') }}');
        })();
